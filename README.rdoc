...
What we need to do:
-Add passwords to the chefs table so chefs can be authenticated and logged instructions
-Use email as log in credentials, sincer email is unique
...
2) Navigation partial -> Toggle Menu, restirct new
3) Restrict thumbs up and thumbs sown action to logged_in users only
